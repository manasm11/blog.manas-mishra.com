...
<DownloadableLink href="/downloads/anki/consumer-behavior.apkg" label="Download Anki Deck — Consumer Behavior" />
...
<ShowImage name="023.jpg" caption="Engel-Blackwell-Miniard Model for comprehensive consumer decision making" />

<Define term="Divestment">
...
<ShowImage name="025.png" caption="There are 13 faces in this image" />
<ShowImage name="026.png" caption="There are two old men in this image" />
<ShowImage name="027.png" caption="There are 5 people in this image" />
<ShowImage name="028.png" caption="There are 6 wolves in the image" />
...
<ShowImage name="029.png" caption="" />
...
<ShowImage name="030.png" caption="" />
...
<ShowImage name="031.png" caption="" />
...
<ShowImage name="032.png" caption="" />
...
<ShowImage name="033.png" caption="" />
<ShowImage name="034.png" caption="" />
<ShowImage name="035.png" caption="" />
...
<ShowImage name="036.png" caption="" />
3. **Closure**: If first and the last words are same, you read it as something you already know.
<ShowImage name="037.png" caption="" />
<ShowImage name="038.png" caption="" />
...
<ShowImage name="039.png" caption="" />

## Attitude
<Define term="Attitude">
...
<Define term="Market Creation Process">
...
<ShowImage name="040.png" caption="Tri-Component Model of Attitude (Generated using DALL-E)" />
...
<Define term="Attitude-Culture Conflict">
...
<ShowImage name="041.png" caption="Compensatory Decision Making Rule" />

2. **Conjunctive Rule**: Lower cut-off for any feature is set for disregarding options from choice set.
<ShowImage name="042.png" caption="Conjunctive Decision Making Rule" />

3. **Disjunctive Rule**: Higher cut-off for a feature is set for creating choice set.
<ShowImage name="043.png" caption="Disjunctive Decision Making Rule" />
