...
import DownloadableLink from '@components/DownloadableLink.astro';
import Collapse from '@components/Collapse.astro';
import MuReference from '@components/MuReference.astro';
import { Aside } from '@astrojs/starlight/components';


<MuReference />

<DownloadableLink href="/downloads/anki/marketing-basics.apkg" label="Download Anki Deck — Marketing Basics" />

<Define term="Marketing">
...
<Define term="Attitudinal Loyalty">
...
2. Create solution
3. Propose Value
4. Convert demand to desire (Enhance Value)
5. Match expectations with Perceived Delivery
...
<Define term="Psychological Variables">
...
<Collapse label="**Distance Formula**">
...
<Collapse label="**Clustering Algorithm Brief**">
...
<Define term="TAM (Total Addressable Market)">
...
<Define term="SAM (Serviceable Available Market)">
...
<Define term="SOM (Serviceable Obtainable Market)">
...
<Define term="Point of Difference">
...
<Define term="Market Penetration Strategy">
Increasing the consumption of existing products to existing consumers.
</Define>

<Define term="Market Development Strategy">
...
<Define term="Product Development Strategy">
Creating new products for existing customers (segments).
</Define>

<Define term="Diversification">
...
<Define term="High Information Product">
...
<Define term="High Customization Product">
...
A good paper to have better reference is <DownloadableLink href="/marketing_docs/Integrated Marketing Communications.pdf" label="Integrated Marketing Communications" /> paper.
...
Reading Material
1. <DownloadableLink href="https://drive.google.com/file/d/11OnRastCA9Y785ueKz4GaCqZwDg8LbtN/view?usp=sharing" label="Beyond the Many Faces of Price" />
2. <DownloadableLink href="https://drive.google.com/file/d/1SW4OQU8tC05vFQWsYiXrpzpXGfNjx6HD/view?usp=sharing" label="Framework for Marketing Strategy Formation" />
3. <DownloadableLink href="https://drive.google.com/file/d/1_8-GnPIRmuWfi1cx2H9TV9pgsm9WyQk2/view?usp=sharing" label="Designing Product and Business Portfolios" />
4. <DownloadableLink href="https://drive.google.com/file/d/1-Atvr_ehKO_lIDluC77k4sh_wUzNP535/view?usp=sharing" label="Economic Foundations of Pricing ~ Nagle" />
5. <DownloadableLink href="https://drive.google.com/file/d/1i69T6nnCgInScXDCGGKD6Jnq_9BKipNe/view?usp=sharing" label="Exploit the Product Life Cycle" />
6. <DownloadableLink href="https://drive.google.com/file/d/18mNsBhYh-51Qv61k3etCR4yFZB8V2xLy/view?usp=sharing" label="Forget the Product Life Cycle Concept" />
7. <DownloadableLink href="https://drive.google.com/file/d/1GkQyg9UNUlXlDoIxjSGhKoCxl5_wdh7H/view?usp=sharing" label="Integrated Marketing Communications" />
8. <DownloadableLink href="https://drive.google.com/file/d/1uwXOJOtZyJ-FQ_TQ-ivPDdKCWck34M02/view?usp=sharing" label="Marketing Consumer Behaviour and Buying Process" />
9. <DownloadableLink href="https://drive.google.com/file/d/13oU5fy-y7UGelmMxnHKrww3TQS7KIbI1/view?usp=sharing" label="Marketing Intangible Products and Product Intangibles" />
10. <DownloadableLink href="https://drive.google.com/file/d/15KxkJX1YUJCaprLWzZ8k-EBEiDfTL4EJ/view?usp=sharing" label="Marketing Myopia" />
11. <DownloadableLink href="https://drive.google.com/file/d/1rvZS-2dE_B6XhdSFcI8lPmT1MQm-zP6X/view?usp=sharing" label="Marketing Strategy — An Overview" />
12. <DownloadableLink href="https://drive.google.com/file/d/1c_EEe876g8dEFKzJO91aaqVALu9WCoeO/view?usp=sharing" label="New Criteria for Market Segmentation" />
13. <DownloadableLink href="https://drive.google.com/file/d/1qDL-EopWc2D8tqScq3w8yOfPXXgRQI_V/view?usp=sharing" label="Product Policy Quelch" />
14. <DownloadableLink href="https://drive.google.com/file/d/1d6dw42WiGrgN11sTCAc4b73iQLi73O4I/view?usp=sharing" label="Should you take your brand to where the action is" />
15. <DownloadableLink href="https://drive.google.com/file/d/1d6dw42WiGrgN11sTCAc4b73iQLi73O4I/view?usp=sharing" label="The Brand Report Card" />
16. <DownloadableLink href="https://drive.google.com/file/d/1Cr25aH2iDs8NqgyQOt4uBn8G_z-P8wUL/view?usp=sharing" label="The Customer Has Escaped" />
